...
export default function Login() {
  ...
  useEffect(() => {
    if (isAuthenticated && roleFetched && isAdmin && profileFetched && userProfile !== null) {
      navigate({ to: '/admin' });
    }
  }, [isAuthenticated, roleFetched, isAdmin, profileFetched, userProfile, navigate]);
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-md mx-auto bg-card rounded-2xl shadow-xl p-8 md:p-12">
          ...
          <div className="space-y-6">
            ...
            {isAuthenticated && roleFetched && !isAdmin && (
